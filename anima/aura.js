...
// sta funzione mi sa che non funzia...
function loadJS(jslocation, fn){
     //"location" is the location to insert the <script> element -- NOPE, ora è sempre document.head
     //"load" is the function to be executed after onload
     if(isJust(jslocation) && isJust(fn)){
